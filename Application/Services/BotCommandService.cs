...
public class BotCommandService : IBotCommandService
{
    ...
    public Task<string?> ProcessMessageAsync(string content, string username, string userMention)
    {
        ...
        else if(content.Equals("ema", StringComparison.OrdinalIgnoreCase))
        {
            _logger.LogInformation("Enviar foto del gato naranja llamado ema");
            return Task.FromResult<string?>("https://klipy.com/gifs/thatscrazydude");
        }
